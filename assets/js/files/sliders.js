 ...
 * Инициализация слайдера
 */
const isOthersPosibilitieSlidesOutside = isSlidesOutside(
	document.querySelector(".others-posibilities-slider__slides")
);
 ...
 * Инициализация слайдера
 */
const isAdvantageSlidesOutside = isSlidesOutside(
	document.querySelector(".advantages-slider__slides"),
 ...
 * Инициализация слайдера
 */
const isPartnersSlidesOutside = isSlidesOutside(
	document.querySelector(".partners-slider__slides"),
	document.querySelector(".partners__container")
);

const partnersSlider = new Swiper(".partners-slider", {
	speed: 500,
	spaceBetween: isPartnersSlidesOutside ? 97 : 0,
	loop: true,
	navigation: {
	...
	on: {
		init: (swiper) => isPartnersSlidesOutside && swiper.el.classList.add("_outside"),
	},
});
